(function() {
  var Project, Updater, Windows, _, api, connect, dialog, errors, handleEvent, ipc, konfig, log, logs, open, openProject, pkg, shell, user;
  ...
  handleEvent = function(options, bus, event, id, type, arg) {
    ...
    switch (type) {
      ...
      case "window:open":
        return Windows.open(arg).then(send)["catch"](sendErr);
      case "window:close":
