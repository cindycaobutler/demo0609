(function() {
  var Project, Promise, Reporter, TITLE_SEPARATOR, Windows, _, chalk, collectTestResults, errors, fs, haveProjectIdAndKeyButNoRecordOption, human, humanTime, log, openProject, path, pkg, progress, random, ss, stats, terminal, trash, user, uuid, video;
  ...
  module.exports = {
    ...
    listenForProjectEnd: function(project, headed) {
    ...
    waitForTestsToFinishRunning: function(options) {
      var cname, end, headed, name, outputPath, project, screenshots, started, videoCompression, videoUploadOnPasses;
      if (options == null) {
        options = {};
      }
      project = options.project, headed = options.headed, screenshots = options.screenshots, started = options.started, end = options.end, name = options.name, cname = options.cname, videoCompression = options.videoCompression, videoUploadOnPasses = options.videoUploadOnPasses, outputPath = options.outputPath;
      return this.listenForProjectEnd(project, headed).then((function(_this) {
        return function(obj) {
    ...
    ready: function(options) {
      ...
      id = this.getId();
      return Project.ensureExists(options.projectPath).then((function(_this) {
        return function() {
