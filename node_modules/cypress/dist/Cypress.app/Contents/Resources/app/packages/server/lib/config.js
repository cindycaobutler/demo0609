(function() {
  var Promise, _, coerce, configKeys, convertRelativeToAbsolutePaths, cypressEnvRe, dashesOrUnderscoresRe, defaults, errors, folders, fs, isCypressEnvLike, log, origin, path, pathHelpers, scaffold, settings, toWords, v, validate, validationRules;
