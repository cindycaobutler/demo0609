(function() {
  var Promise, _, check, coffee, cwd, extensions, fs, jsonlint, lastCharacterIsNewLine, path, queue;
  ...
  module.exports = {
    ...
    parseJson: function(p, fixture) {
      return fs.readFileAsync(p, "utf8").bind(this).then(jsonlint.parse)["catch"](function(err) {
